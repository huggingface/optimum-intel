...
class Phi3ModelPatcher(DecoderModelPatcher):
    def __enter__(self):
        ...
        for layer in self._model.model.layers:
            ...
            if hasattr(layer.self_attn, "rotary_emb") and getattr(layer.self_attn.rotary_emb, "inv_freq", None) is None:
...
# Modified from https://huggingface.co/microsoft/Phi-3.5-MoE-instruct/blob/main/modeling_phimoe.py#L1015
# removed usage nonfriendly for tracing operations: continue and tolist()
...
class PhiMoEModelPatcher(Phi3ModelPatcher):
    def __enter__(self):
        ...
        for layer in self._model.model.layers:
            ...
            layer.block_sparse_moe.forward = types.MethodType(_phi_moe_sparse_moe_block_forward, layer.block_sparse_moe)
