...
# `SelectiveSSMRecurrentCell` (same as NemotronH), which is replaced by an `ov::Loop` during
...
#    `SelectiveSSMRecurrentCell`), which is replaced by an `ov::Loop` during conversion.
    ...
    def __enter__(self):
        ...
        for decoder_layer in self._model.model.layers:
            ...
            if isinstance(mixer, NemotronHMamba2Mixer):
                ...
                mixer.selective_ssm_recurrent_cell = SelectiveSSMRecurrentCell()
