...
class OVModelForSpeechSeq2Seq(metaclass=DummyObject):
    _backends = ["openvino"]
...
class OVModelForVision2Seq(metaclass=DummyObject):
    _backends = ["openvino"]
...
class OVModelForVisualCausalLM(metaclass=DummyObject):
    _backends = ["openvino"]
...
class OVSamModel(metaclass=DummyObject):
    _backends = ["openvino"]
...
class OVModelForTextToSpeechSeq2Seq(metaclass=DummyObject):
    _backends = ["openvino"]
