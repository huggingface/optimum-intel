...
class OVSeedVR2Pipeline(metaclass=DummyObject):
    _backends = ["openvino", "diffusers"]
...
class OVFlux2KleinPipeline(metaclass=DummyObject):
    _backends = ["openvino", "diffusers"]
...
class OVQwenImagePipeline(metaclass=DummyObject):
    _backends = ["openvino", "diffusers"]
...
class OVQwenImage21Pipeline(metaclass=DummyObject):
    _backends = ["openvino", "diffusers"]
...
class OVZImageImg2ImgPipeline(metaclass=DummyObject):
    _backends = ["openvino", "diffusers"]
...
class OVZImageInpaintPipeline(metaclass=DummyObject):
    _backends = ["openvino", "diffusers"]
