...
def pipeline(  # noqa: D417
    ...
    # framework: Optional[str] = None, # we leave it as None to trigger model loading with ov_infer_framework_load_model
    ...
    **kwargs: Any,
    ...
    >>> analyzer = pipeline("sentiment-analysis", accelerator="openvino")
    ...
    >>> model = OVModelForTokenClassification.from_pretrained("dbmdz/bert-large-cased-finetuned-conll03-english")
    >>> tokenizer = AutoTokenizer.from_pretrained("google-bert/bert-base-cased")
    >>> recognizer = pipeline("ner", model=model, tokenizer=tokenizer, accelerator="openvino")
    ```
    """
