...
from optimum.intel.neural_compressor import INCQuantizedModelForTokenClassification, INCQuantizer, INCTrainer
...
require_version(
    "datasets>=1.8.0", "To fix: pip install -r examples/neural_compressor/token-classification/requirements.txt"
)
