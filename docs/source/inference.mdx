...
Here is an example of how you can load a stable diffusion model, export it to the OpenVINO format and run inference using OpenVINO Runtime:
...
![img](https://huggingface.co/datasets/optimum/documentation-images/resolve/main/openvino/stable_diffusion_v2_1_sail_boat.png)
