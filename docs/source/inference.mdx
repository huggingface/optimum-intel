...
```python
# Define the desired input shapes
batch_size = 1
...
In case you want to change any parameters of your input shapes, you'll need to redo the entire process :
