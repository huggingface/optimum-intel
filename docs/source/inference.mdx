...
See the [reference documentation](https://huggingface.co/docs/optimum/intel/reference_ov) for more information about parameters, and examples for different tasks.
