...
| `int8`                               | INT8 weights.      |
| `int4_sym_g128`                      | INT4 *symmetrically* quantized weights of most of the Linear layers with group size 128. The rest of the Linear layers and all Embeddings are quantized to INT8.   |
