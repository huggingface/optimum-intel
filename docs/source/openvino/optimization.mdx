...
import CopyButton from './copy_command.svelte';
    ...
    <tbody>
        <tr>
            ...
            <td style="text-align: center; vertical-align: middle;">
                <CopyButton command="optimum-cli export openvino -m TinyLlama/TinyLlama-1.1B-Chat-v1.0 --weight-format int8 ./save_dir" />
            </td>
            <td style="text-align: center; vertical-align: middle;">
                <button
