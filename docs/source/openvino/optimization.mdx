...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center; vertical-align: middle;">
                <button
                    onclick="navigator.clipboard.writeText('optimum-cli export openvino -m microsoft/speecht5_tts --model-kwargs "{\\"vocoder\\": \\"microsoft/speecht5_hifigan\\"}" --weight-format int8 ./save_dir')">
                    ✅
                </button>
            </td>
            <td style="text-align: center; vertical-align: middle;">
        ...
        <tr>
            <td style="text-align: center; vertical-align: middle;">text-to-video<br>(OVLTXPipeline)</td>
            <td style="text-align: center; vertical-align: middle;">–</td>
            <td style="text-align: center; vertical-align: middle;">–</td>
            <td style="text-align: center; vertical-align: middle;">–</td>
            <td style="text-align: center; vertical-align: middle;">–</td>
