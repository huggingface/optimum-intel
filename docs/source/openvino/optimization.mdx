...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: center; vertical-align: middle;">More actions
                <button onclick="navigator.clipboard.writeText('OVModelForTextToSpeechSeq2Seq.from_pretrained(\'microsoft/speecht5_tts\', vocoder=\'microsoft/speecht5_hifigan\', quantization_config=OVWeightQuantizationConfig(bits=8)).save_pretrained(\'save_dir\')')">
                    ✅
                </button>More actions
            </td>
            <td style="text-align: center; vertical-align: middle;">–</td>
