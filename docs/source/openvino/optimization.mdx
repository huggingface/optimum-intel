...
<table>
    <thead>
        <tr>
            <th rowspan="2">Task (Class)</th>
            <th colspan="4">Weight-only quantization</th>
            <th colspan="2">Hybrid Quantization</th>
            <th colspan="2">Full Quantization</th>
            <th colspan="2">Mixed Quantization</th>
        </tr>
        <tr class="sub-header">
            <th colspan="2">Data-free</th>
            <th colspan="2">Data-aware</th>
            <th rowspan="1">CLI</th>
            <th rowspan="1">Python API</th>
            <th rowspan="1">CLI</th>
            <th rowspan="1">Python API</th>
            <th rowspan="1">CLI</th>
            <th rowspan="1">Python API</th>
    ...
    <tbody>
        <tr>
            <td>text-generation (OVModelForCausalLM)</td>
        ...
        <tr>
            <td>image-text-to-text (OVModelForVisualCausalLM)</td>
            <td>+</td><td>+</td><td>+</td><td>+</td>
            <td>-</td><td>-</td>
            <td>-</td><td>-</td>
            <td>-</td><td>-</td>
        ...
        <tr>
            <td>text-to-image (OVStableDiffusionPipeline)</td>
            <td>+</td><td>+</td><td>-</td><td>-</td>
            <td>-</td><td>-</td>
            <td>+</td><td>+</td>
            <td>-</td><td>-</td>
        ...
        <tr>
            <td>automatic-speech-recognition (OVModelForSpeechSeq2Seq)</td>
            <td>-</td><td>-</td><td>-</td><td>-</td>
            <td>-</td><td>-</td>
            <td>+</td><td>+</td>
            <td>-</td><td>-</td>
