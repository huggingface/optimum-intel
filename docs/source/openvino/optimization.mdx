...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><button onclick="navigator.clipboard.writeText('optimum-cli export openvino -m HuggingFaceH4/tiny-random-LlamaForCausalLM --weight-format int4 --group-size 4 ./save_dir')">+</button></td><td>+</td><td>+</td><td>+</td>
            <td>+</td><td>-</td>
            <td>+</td><td>-</td>
            <td>+</td><td>+</td>
        </tr>
