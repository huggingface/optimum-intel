...
For example, the code below compresses weights a language model inside InternVL2-1B to int4, weights of a text embedding model to int8 and skips any quantization for vision embedding model.
