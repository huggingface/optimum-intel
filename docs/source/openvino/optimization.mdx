...
<table>
    <thead>
        <tr class="bg-[#FFD56B] dark:bg-[#5A4B32] text-black">
            <th rowspan="3" class="border border-gray-300 dark:border-gray-600 p-2 text-center">Task<br>(OV Model Class)</th>
            <th colspan="4" class="border border-gray-300 dark:border-gray-600 p-2 text-center">Weight-only Quantization</th>
            <th colspan="2" class="border border-gray-300 dark:border-gray-600 p-2 text-center" rowspan="2">Hybrid Quantization</th>
            <th colspan="2" class="border border-gray-300 dark:border-gray-600 p-2 text-center" rowspan="2">Full Quantization</th>
            <th colspan="2" class="border border-gray-300 dark:border-gray-600 p-2 text-center" rowspan="2">Mixed Quantization</th>
        </tr>
        <tr class="bg-[#FFD56B] dark:bg-[#5A4B32] text-black">
            <th colspan="2" class="border border-gray-300 dark:border-gray-600 p-2 text-center">Data-free</th>
            <th colspan="2" class="border border-gray-300 dark:border-gray-600 p-2 text-center">Data-aware</th>
        </tr>
        <tr class="bg-[#FFD56B] dark:bg-[#5A4B32] text-black">
            <th class="border border-gray-300 dark:border-gray-600 p-2 text-center">CLI</th>
            <th class="border border-gray-300 dark:border-gray-600 p-2 text-center">Python</th>
            <th class="border border-gray-300 dark:border-gray-600 p-2 text-center">CLI</th>
            <th class="border border-gray-300 dark:border-gray-600 p-2 text-center">Python</th>
            <th class="border border-gray-300 dark:border-gray-600 p-2 text-center">CLI</th>
            <th class="border border-gray-300 dark:border-gray-600 p-2 text-center">Python</th>
