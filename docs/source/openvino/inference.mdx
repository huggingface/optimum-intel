...
See the [reference documentation](inference#optimum.intel.openvino.modeling_base.OVBaseModel.reshape) for more information about parameters.
...
Here is an example on how you can run inference for a translation task using a T5 model:
