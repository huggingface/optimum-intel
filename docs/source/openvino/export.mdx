...
Optional arguments:
  ...
  --awq                 Whether to apply AWQ algorithm. AWQ improves generation quality of INT4-compressed LLMs. If
                        dataset is provided, a data-aware mode of the algorithm will be executed, which requires
                        additional time; otherwise, data-free AWQ will be applied. Note: it is possible that there will
