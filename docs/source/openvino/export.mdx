...
```bash
optimum-cli export openvino -m openai/whisper-large-v3-turbo --quant-mode int8/int8 --dataset librispeech --num-samples 32 --smooth-quant-alpha 0.9 ./whisper-tiny-en
```
