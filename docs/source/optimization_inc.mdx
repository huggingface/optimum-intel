...
Intel(R) Neural Compressor support some quantization recipes. Users can set `recipes` in config class to achieve the some purpose.
...
The SmoothQuant methodology is available for post-training quantization.
...
```
Validated Models with smooth quant: [models](https://github.com/intel/neural-compressor/blob/master/docs/source/smooth_quant.md#validated-models)
