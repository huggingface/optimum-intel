...
[OpenVINO](https://docs.openvino.ai/latest/openvino_docs_OV_UG_OV_Runtime_User_Guide.html) is an open-source toolkit enabling models optimization and providing inference solutions.
