...
<div class="mt-10">
  <div class="w-full flex flex-col space-x-4  md:grid md:grid-cols-2 md:gap-x-5">
    ...
    <a class="!no-underline border dark:border-gray-700 p-5 rounded-lg shadow hover:shadow-lg" href="./inference"
      ...
      <p class="text-gray-700">Learn how to run inference with OpenVINO Runtime on a variety of Intel processors (see the full list of supported devices). You will also learn how to apply quantization, pruning and knowledge distillation on your model to further speed up inference</p>
    </a>
  </div>
</div>
