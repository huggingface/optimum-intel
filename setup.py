...
EXTRAS_REQUIRE = {
    ...
    "openvino": ["openvino-nightly==2024.2.0.dev20240523", "nncf@git+https://github.com/openvinotoolkit/nncf.git@release_v2110", "openvino-tokenizers[transformers]"],
    "nncf": ["nncf@git+https://github.com/openvinotoolkit/nncf.git@release_v2110"],
