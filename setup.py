...
INSTALL_REQUIRE = [
    ...
    "optimum@git+https://github.com/huggingface/optimum.git@transformers-4.44",
    "datasets>=1.4.0",
    "sentencepiece",
    "setuptools",
    "scipy",
...
EXTRAS_REQUIRE = {
    "neural-compressor": ["neural-compressor>=2.2.0,<3.0", "accelerate", "transformers<4.45.0"],
    "openvino": ["openvino>=2023.3", "nncf>=2.11.0", "openvino-tokenizers[transformers]"],
    "nncf": ["nncf>=2.11.0"],
    "ipex": ["intel-extension-for-pytorch", "transformers>=4.39.0,<4.45.0"],
    "diffusers": ["diffusers"],
