...
class ModelingIntegrationTest(unittest.TestCase):
    ...
    def test_compare_to_transformers(self, model_arch):
        ...
        set_seed(SEED)
        model = TracedModelForCausalLM.from_pretrained(model_id, export=True)
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            loaded_model = TracedModelForCausalLM.from_pretrained(tmpdirname)
    ...
    def test_compare_with_and_without_past_key_values(self):
        ...
        model_with_pkv = TracedModelForCausalLM.from_pretrained(model_id, export=True, use_cache=True)
        # Warmup
        ...
        model_without_pkv = TracedModelForCausalLM.from_pretrained(model_id, export=True, use_cache=False)
        # Warmup
