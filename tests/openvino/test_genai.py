...
- OpenVINO device can be set by environment variable OPENVINO_TEST_DEVICE
  ...
  - For GPU, there are known failed tests on some GPUs: qwen2_moe, qwen3_moe, qwen2_vl, qwen2_5_vl, speecht5, qwen3_eagle3.
...
class LLMPipelineTestCase(unittest.TestCase):
    ...
    if is_transformers_version(">=", "4.46.0"):
        ALL_SUPPORTED_ARCHITECTURES += ("glm", "mistral-nemo", "phimoe", "opt")
