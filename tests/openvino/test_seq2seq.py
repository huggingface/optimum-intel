...
from optimum.exporters.openvino.model_configs import Gemma3nTextOpenVINOConfig, Qwen3OmniMoeOpenVINOConfig
...
class OVSeq2SeqTestMixin(unittest.TestCase):
    ...
    def _test_find_untested_architectures(self):
        ...
        if is_transformers_version("<", str(Qwen3OmniMoeOpenVINOConfig.MIN_TRANSFORMERS_VERSION)):
...
class OVModelForMultimodalLMIntegrationTest(unittest.TestCase):
    ...
    def test_save_and_reload(self):
        ...
        with TemporaryDirectory() as save_dir:
            ...
            restored = OVModelForMultimodalLM.from_pretrained(save_dir, device=OPENVINO_DEVICE)
