...
class TestQwen3OmniMoeDispatch(unittest.TestCase):
    """Verify get_openvino_model_class routes qwen3_omni_moe to OVModelForMultimodalLM for all supported tasks."""
    ...
    def test_omni_present_in_all_expected_task_tuples(self):
        ...
        for task in expected_tasks:
            assert OVModelForMultimodalLM in OV_TASKS_MAPPING[task], f"OVModelForMultimodalLM missing from OV_TASKS_MAPPING['{task}']"
